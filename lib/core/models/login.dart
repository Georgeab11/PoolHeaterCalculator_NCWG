...
class Response {
  ...
  set partnerPhoneNumber(String partnerPhoneNumber) =>
      _partnerPhoneNumber = partnerPhoneNumber;

  String get partnerPhoneCountry => _partnerPhoneCountry;

  set partnerPhoneCountry(String partnerPhoneCountry) =>
      _partnerPhoneCountry = partnerPhoneCountry;
  ...
  set userPhoneCountry(String userPhoneCountry) =>
  ...
  Response.fromJson(Map<String, dynamic> json) {
    ...
    _displayMessage = json['DisplayMessage'];
    _waitCount = json['WaitCount'];
    _recallCount = json['RecallCount'];
    _partnerId = json['Partner_Id'];
    _partnerToken = json['Partner_Token'];
    _partnerPhoneNumber = json['Partner_PhoneNumber'];
    _partnerPhoneCountry = json['Partner_PhoneCountry'];
    _userId = json['User_Id'];
    _userToken = json['User_Token'];
    _userPhoneNumber = json['User_PhoneNumber'];
    _userPhoneCountry = json['User_PhoneCountry'];
    _processToken = json['ProcessToken'];
    _data = json['Data'] != null && json['Data'].toString().isNotEmpty
...
class Data {
  ...
  set userFunctionalWallet(String userFunctionalWallet) =>
      _userFunctionalWallet = userFunctionalWallet;

  String get userCreationDateTime => _userCreationDateTime;

  set userCreationDateTime(String userCreationDateTime) =>
      _userCreationDateTime = userCreationDateTime;
  ...
  set userMaxSponsoredUsers(String userMaxSponsoredUsers) =>
      _userMaxSponsoredUsers = userMaxSponsoredUsers;

  String get userSponsoredUsersCount => _userSponsoredUsersCount;

  set userSponsoredUsersCount(String userSponsoredUsersCount) =>
      _userSponsoredUsersCount = userSponsoredUsersCount;

  String get userVipStatusCount => _userVipStatusCount;

  set userVipStatusCount(String userVipStatusCount) =>
      _userVipStatusCount = userVipStatusCount;

  String get userAccessKeyMobileCity => _userAccessKeyMobileCity;

  set userAccessKeyMobileCity(String userAccessKeyMobileCity) =>
      _userAccessKeyMobileCity = userAccessKeyMobileCity;

  String get userWordPressId => _userWordPressId;

  set userWordPressId(String userWordPressId) =>
      _userWordPressId = userWordPressId;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    _userGenderText = json['User_GenderText'];
    ...
    _userZipCode = json['User_ZipCode'];
    _userCity = json['User_City'];
    _userPhoneNumber = json['User_PhoneNumber'];
    _userLanguage = json['User_Language'];
    _userEMail = json['User_EMail'];
    _userLatitude = json['User_Latitude'];
    _userLongitude = json['User_Longitude'];
    _userWalletId = json['User_WalletId'];
    _userSignature = json['User_Signature'];
    _userFunctionalWallet = json['User_FunctionalWallet'];
    _userCreationDateTime = json['User_CreationDateTime'];
    _userBirthDay = json['User_BirthDay'];
    _userMaxSponsoredUsers = json['User_MaxSponsoredUsers'];
    _userSponsoredUsersCount = json['User_SponsoredUsersCount'];
    _userVipStatusCount = json['User_VipStatusCount'];
    _userAccessKeyMobileCity = json['User_AccessKeyMobileCity'];
    _userWordPressId = json['User_WordPressId'];
